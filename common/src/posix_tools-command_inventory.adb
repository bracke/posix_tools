package body Posix_Tools.Command_Inventory is
   ...
   Inventory : constant array (Positive range 1 .. Command_Count) of Command_Descriptor :=
     [1  => (Basename_Exe'Access, Basename_Crate'Access, Basename_Pkg'Access, Conforming_With_Extensions'Access),
      ...
      16 => (Expr_Exe'Access, Expr_Crate'Access, Expr_Pkg'Access, Conforming_With_Extensions'Access),
      17 => (False_Exe'Access, False_Crate'Access, False_Pkg'Access, Conforming_With_Extensions'Access),
      18 => (File_Exe'Access, File_Crate'Access, File_Pkg'Access, Conforming_With_Extensions'Access),
      19 => (Find_Exe'Access, Find_Crate'Access, Find_Pkg'Access, Conforming_With_Extensions'Access),
      20 => (Head_Exe'Access, Head_Crate'Access, Head_Pkg'Access, Conforming_With_Extensions'Access),
      21 => (Id_Exe'Access, Id_Crate'Access, Id_Pkg'Access, Conforming_With_Extensions'Access),
      22 => (Kill_Exe'Access, Kill_Crate'Access, Kill_Pkg'Access, Conforming_With_Extensions'Access),
      23 => (Link_Exe'Access, Link_Crate'Access, Link_Pkg'Access, Conforming_With_Extensions'Access),
      24 => (Ln_Exe'Access, Ln_Crate'Access, Ln_Pkg'Access, Conforming_With_Extensions'Access),
      25 => (Logname_Exe'Access, Logname_Crate'Access, Logname_Pkg'Access, Conforming_With_Extensions'Access),
      26 => (Ls_Exe'Access, Ls_Crate'Access, Ls_Pkg'Access, Conforming_With_Extensions'Access),
      27 => (Mkdir_Exe'Access, Mkdir_Crate'Access, Mkdir_Pkg'Access, Conforming_With_Extensions'Access),
      28 => (Mv_Exe'Access, Mv_Crate'Access, Mv_Pkg'Access, Conforming_With_Extensions'Access),
      29 => (Od_Exe'Access, Od_Crate'Access, Od_Pkg'Access, Conforming_With_Extensions'Access),
      30 => (Paste_Exe'Access, Paste_Crate'Access, Paste_Pkg'Access, Conforming_With_Extensions'Access),
      31 => (Pathchk_Exe'Access, Pathchk_Crate'Access, Pathchk_Pkg'Access, Conforming_With_Extensions'Access),
      32 => (Printf_Exe'Access, Printf_Crate'Access, Printf_Pkg'Access, Conforming_With_Extensions'Access),
      33 => (Pwd_Exe'Access, Pwd_Crate'Access, Pwd_Pkg'Access, Conforming_With_Extensions'Access),
      34 => (Readlink_Exe'Access, Readlink_Crate'Access, Readlink_Pkg'Access, Conforming_With_Extensions'Access),
      35 => (Realpath_Exe'Access, Realpath_Crate'Access, Realpath_Pkg'Access, Conforming_With_Extensions'Access),
      36 => (Rm_Exe'Access, Rm_Crate'Access, Rm_Pkg'Access, Conforming_With_Extensions'Access),
      37 => (Rmdir_Exe'Access, Rmdir_Crate'Access, Rmdir_Pkg'Access, Conforming_With_Extensions'Access),
      38 => (Sleep_Exe'Access, Sleep_Crate'Access, Sleep_Pkg'Access, Conforming_With_Extensions'Access),
      39 => (Split_Exe'Access, Split_Crate'Access, Split_Pkg'Access, Conforming_With_Extensions'Access),
      40 => (Sort_Exe'Access, Sort_Crate'Access, Sort_Pkg'Access, Conforming_With_Extensions'Access),
      41 => (Tail_Exe'Access, Tail_Crate'Access, Tail_Pkg'Access, Conforming_With_Extensions'Access),
      42 => (Tee_Exe'Access, Tee_Crate'Access, Tee_Pkg'Access, Conforming_With_Extensions'Access),
      43 => (Test_Exe'Access, Test_Crate'Access, Test_Pkg'Access, Conforming_With_Extensions'Access),
      44 => (Timeout_Exe'Access, Timeout_Crate'Access, Timeout_Pkg'Access, Conforming_With_Extensions'Access),
      45 => (Touch_Exe'Access, Touch_Crate'Access, Touch_Pkg'Access, Conforming_With_Extensions'Access),
      46 => (Tr_Exe'Access, Tr_Crate'Access, Tr_Pkg'Access, Conforming_With_Extensions'Access),
      47 => (True_Exe'Access, True_Crate'Access, True_Pkg'Access, Conforming_With_Extensions'Access),
      48 => (Tty_Exe'Access, Tty_Crate'Access, Tty_Pkg'Access, Conforming_With_Extensions'Access),
      49 => (Uname_Exe'Access, Uname_Crate'Access, Uname_Pkg'Access, Conforming_With_Extensions'Access),
      50 => (Uniq_Exe'Access, Uniq_Crate'Access, Uniq_Pkg'Access, Conforming_With_Extensions'Access),
      51 => (Wc_Exe'Access, Wc_Crate'Access, Wc_Pkg'Access, Conforming_With_Extensions'Access),
      52 => (Whoami_Exe'Access, Whoami_Crate'Access, Whoami_Pkg'Access, Conforming_With_Extensions'Access),
      53 => (Xargs_Exe'Access, Xargs_Crate'Access, Xargs_Pkg'Access, Conforming_With_Extensions'Access)];
