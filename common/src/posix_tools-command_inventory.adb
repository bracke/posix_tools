package body Posix_Tools.Command_Inventory is
   ...
   Arch_Exe     : aliased constant String := "arch";
   ...
   Df_Exe       : aliased constant String := "df";
   ...
   Getconf_Exe  : aliased constant String := "getconf";
   Groups_Exe   : aliased constant String := "groups";
   Head_Exe     : aliased constant String := "head";
   Hostname_Exe : aliased constant String := "hostname";
   ...
   Sha256sum_Exe : aliased constant String := "sha256sum";
   Sleep_Exe    : aliased constant String := "sleep";
   Split_Exe    : aliased constant String := "split";
   Stat_Exe     : aliased constant String := "stat";
   ...
   Df_Crate       : aliased constant String := "posix_tools_df";
   ...
   Getconf_Crate  : aliased constant String := "posix_tools_getconf";
   Groups_Crate   : aliased constant String := "posix_tools_groups";
   Head_Crate     : aliased constant String := "posix_tools_head";
   Hostname_Crate : aliased constant String := "posix_tools_hostname";
   ...
   Locale_Crate   : aliased constant String := "posix_tools_locale";
   ...
   Mkfifo_Crate   : aliased constant String := "posix_tools_mkfifo";
   Mv_Crate       : aliased constant String := "posix_tools_mv";
   Nice_Crate     : aliased constant String := "posix_tools_nice";
   Nl_Crate       : aliased constant String := "posix_tools_nl";
   Nohup_Crate    : aliased constant String := "posix_tools_nohup";
   ...
   Printenv_Crate : aliased constant String := "posix_tools_printenv";
   ...
   Sha256sum_Crate : aliased constant String := "posix_tools_sha256sum";
   Sleep_Crate    : aliased constant String := "posix_tools_sleep";
   Split_Crate    : aliased constant String := "posix_tools_split";
   Stat_Crate     : aliased constant String := "posix_tools_stat";
   ...
   Which_Crate    : aliased constant String := "posix_tools_which";
   ...
   Arch_Pkg     : aliased constant String := "Posix_Tools.Commands.Arch";
   ...
   Df_Pkg       : aliased constant String := "Posix_Tools.Commands.Df";
   ...
   Getconf_Pkg  : aliased constant String := "Posix_Tools.Commands.Getconf";
   Groups_Pkg   : aliased constant String := "Posix_Tools.Commands.Groups";
   Head_Pkg     : aliased constant String := "Posix_Tools.Commands.Head";
   Hostname_Pkg : aliased constant String := "Posix_Tools.Commands.Hostname";
   ...
   Locale_Pkg   : aliased constant String := "Posix_Tools.Commands.Locale";
   ...
   Mkfifo_Pkg   : aliased constant String := "Posix_Tools.Commands.Mkfifo";
   Mv_Pkg       : aliased constant String := "Posix_Tools.Commands.Mv";
   Nice_Pkg     : aliased constant String := "Posix_Tools.Commands.Nice";
   Nl_Pkg       : aliased constant String := "Posix_Tools.Commands.Nl";
   Nohup_Pkg    : aliased constant String := "Posix_Tools.Commands.Nohup";
   ...
   Printenv_Pkg : aliased constant String := "Posix_Tools.Commands.Printenv";
   ...
   Sha256sum_Pkg : aliased constant String := "Posix_Tools.Commands.Sha256sum";
   Sleep_Pkg    : aliased constant String := "Posix_Tools.Commands.Sleep";
   Split_Pkg    : aliased constant String := "Posix_Tools.Commands.Split";
   Stat_Pkg     : aliased constant String := "Posix_Tools.Commands.Stat";
   ...
   Which_Pkg    : aliased constant String := "Posix_Tools.Commands.Which";
   ...
   Inventory : constant array (Positive range 1 .. Command_Count) of Command_Descriptor :=
     [1  => (Arch_Exe'Access, Arch_Crate'Access, Arch_Pkg'Access, Conforming_With_Extensions'Access),
      2  => (Basename_Exe'Access, Basename_Crate'Access, Basename_Pkg'Access, Conforming_With_Extensions'Access),
      3  => (Cat_Exe'Access, Cat_Crate'Access, Cat_Pkg'Access, Conforming_With_Extensions'Access),
      4  => (Chgrp_Exe'Access, Chgrp_Crate'Access, Chgrp_Pkg'Access, Conforming_With_Extensions'Access),
      5  => (Chmod_Exe'Access, Chmod_Crate'Access, Chmod_Pkg'Access, Conforming_With_Extensions'Access),
      6  => (Chown_Exe'Access, Chown_Crate'Access, Chown_Pkg'Access, Conforming_With_Extensions'Access),
      7  => (Cksum_Exe'Access, Cksum_Crate'Access, Cksum_Pkg'Access, Conforming_With_Extensions'Access),
      8  => (Cmp_Exe'Access, Cmp_Crate'Access, Cmp_Pkg'Access, Conforming_With_Extensions'Access),
      9  => (Comm_Exe'Access, Comm_Crate'Access, Comm_Pkg'Access, Conforming_With_Extensions'Access),
      10 => (Cp_Exe'Access, Cp_Crate'Access, Cp_Pkg'Access, Conforming_With_Extensions'Access),
      11 => (Cut_Exe'Access, Cut_Crate'Access, Cut_Pkg'Access, Conforming_With_Extensions'Access),
      12 => (Date_Exe'Access, Date_Crate'Access, Date_Pkg'Access, Conforming_With_Extensions'Access),
      13 => (Dd_Exe'Access, Dd_Crate'Access, Dd_Pkg'Access, Conforming_With_Extensions'Access),
      14 => (Df_Exe'Access, Df_Crate'Access, Df_Pkg'Access, Conforming_With_Extensions'Access),
      15 => (Dirname_Exe'Access, Dirname_Crate'Access, Dirname_Pkg'Access, Conforming_With_Extensions'Access),
      16 => (Du_Exe'Access, Du_Crate'Access, Du_Pkg'Access, Conforming_With_Extensions'Access),
      17 => (Echo_Exe'Access, Echo_Crate'Access, Echo_Pkg'Access, Conforming_With_Extensions'Access),
      18 => (Env_Exe'Access, Env_Crate'Access, Env_Pkg'Access, Conforming_With_Extensions'Access),
      19 => (Expand_Exe'Access, Expand_Crate'Access, Expand_Pkg'Access, Conforming_With_Extensions'Access),
      20 => (Expr_Exe'Access, Expr_Crate'Access, Expr_Pkg'Access, Conforming_With_Extensions'Access),
      21 => (False_Exe'Access, False_Crate'Access, False_Pkg'Access, Conforming_With_Extensions'Access),
      22 => (File_Exe'Access, File_Crate'Access, File_Pkg'Access, Conforming_With_Extensions'Access),
      23 => (Find_Exe'Access, Find_Crate'Access, Find_Pkg'Access, Conforming_With_Extensions'Access),
      24 => (Fold_Exe'Access, Fold_Crate'Access, Fold_Pkg'Access, Conforming_With_Extensions'Access),
      25 => (Getconf_Exe'Access, Getconf_Crate'Access, Getconf_Pkg'Access, Conforming_With_Extensions'Access),
      26 => (Groups_Exe'Access, Groups_Crate'Access, Groups_Pkg'Access, Conforming_With_Extensions'Access),
      27 => (Head_Exe'Access, Head_Crate'Access, Head_Pkg'Access, Conforming_With_Extensions'Access),
      28 => (Hostname_Exe'Access, Hostname_Crate'Access, Hostname_Pkg'Access, Conforming_With_Extensions'Access),
      29 => (Id_Exe'Access, Id_Crate'Access, Id_Pkg'Access, Conforming_With_Extensions'Access),
      30 => (Kill_Exe'Access, Kill_Crate'Access, Kill_Pkg'Access, Conforming_With_Extensions'Access),
      31 => (Link_Exe'Access, Link_Crate'Access, Link_Pkg'Access, Conforming_With_Extensions'Access),
      32 => (Ln_Exe'Access, Ln_Crate'Access, Ln_Pkg'Access, Conforming_With_Extensions'Access),
      33 => (Locale_Exe'Access, Locale_Crate'Access, Locale_Pkg'Access, Conforming_With_Extensions'Access),
      34 => (Logname_Exe'Access, Logname_Crate'Access, Logname_Pkg'Access, Conforming_With_Extensions'Access),
      35 => (Ls_Exe'Access, Ls_Crate'Access, Ls_Pkg'Access, Conforming_With_Extensions'Access),
      36 => (Mkdir_Exe'Access, Mkdir_Crate'Access, Mkdir_Pkg'Access, Conforming_With_Extensions'Access),
      37 => (Mkfifo_Exe'Access, Mkfifo_Crate'Access, Mkfifo_Pkg'Access, Conforming_With_Extensions'Access),
      38 => (Mv_Exe'Access, Mv_Crate'Access, Mv_Pkg'Access, Conforming_With_Extensions'Access),
      39 => (Nice_Exe'Access, Nice_Crate'Access, Nice_Pkg'Access, Conforming_With_Extensions'Access),
      40 => (Nl_Exe'Access, Nl_Crate'Access, Nl_Pkg'Access, Conforming_With_Extensions'Access),
      41 => (Nohup_Exe'Access, Nohup_Crate'Access, Nohup_Pkg'Access, Conforming_With_Extensions'Access),
      42 => (Od_Exe'Access, Od_Crate'Access, Od_Pkg'Access, Conforming_With_Extensions'Access),
      43 => (Paste_Exe'Access, Paste_Crate'Access, Paste_Pkg'Access, Conforming_With_Extensions'Access),
      44 => (Pathchk_Exe'Access, Pathchk_Crate'Access, Pathchk_Pkg'Access, Conforming_With_Extensions'Access),
      45 => (Printenv_Exe'Access, Printenv_Crate'Access, Printenv_Pkg'Access, Conforming_With_Extensions'Access),
      46 => (Printf_Exe'Access, Printf_Crate'Access, Printf_Pkg'Access, Conforming_With_Extensions'Access),
      47 => (Pwd_Exe'Access, Pwd_Crate'Access, Pwd_Pkg'Access, Conforming_With_Extensions'Access),
      48 => (Readlink_Exe'Access, Readlink_Crate'Access, Readlink_Pkg'Access, Conforming_With_Extensions'Access),
      49 => (Realpath_Exe'Access, Realpath_Crate'Access, Realpath_Pkg'Access, Conforming_With_Extensions'Access),
      50 => (Rm_Exe'Access, Rm_Crate'Access, Rm_Pkg'Access, Conforming_With_Extensions'Access),
      51 => (Rmdir_Exe'Access, Rmdir_Crate'Access, Rmdir_Pkg'Access, Conforming_With_Extensions'Access),
      52 => (Seq_Exe'Access, Seq_Crate'Access, Seq_Pkg'Access, Conforming_With_Extensions'Access),
      53 => (Sha256sum_Exe'Access, Sha256sum_Crate'Access, Sha256sum_Pkg'Access,
             Conforming_With_Extensions'Access),
      54 => (Sleep_Exe'Access, Sleep_Crate'Access, Sleep_Pkg'Access, Conforming_With_Extensions'Access),
      55 => (Split_Exe'Access, Split_Crate'Access, Split_Pkg'Access, Conforming_With_Extensions'Access),
      56 => (Stat_Exe'Access, Stat_Crate'Access, Stat_Pkg'Access, Conforming_With_Extensions'Access),
      57 => (Sort_Exe'Access, Sort_Crate'Access, Sort_Pkg'Access, Conforming_With_Extensions'Access),
      58 => (Tail_Exe'Access, Tail_Crate'Access, Tail_Pkg'Access, Conforming_With_Extensions'Access),
      59 => (Tee_Exe'Access, Tee_Crate'Access, Tee_Pkg'Access, Conforming_With_Extensions'Access),
      60 => (Test_Exe'Access, Test_Crate'Access, Test_Pkg'Access, Conforming_With_Extensions'Access),
      61 => (Timeout_Exe'Access, Timeout_Crate'Access, Timeout_Pkg'Access, Conforming_With_Extensions'Access),
      62 => (Touch_Exe'Access, Touch_Crate'Access, Touch_Pkg'Access, Conforming_With_Extensions'Access),
      63 => (Tr_Exe'Access, Tr_Crate'Access, Tr_Pkg'Access, Conforming_With_Extensions'Access),
      64 => (True_Exe'Access, True_Crate'Access, True_Pkg'Access, Conforming_With_Extensions'Access),
      65 => (Tty_Exe'Access, Tty_Crate'Access, Tty_Pkg'Access, Conforming_With_Extensions'Access),
      66 => (Unexpand_Exe'Access, Unexpand_Crate'Access, Unexpand_Pkg'Access, Conforming_With_Extensions'Access),
      67 => (Uname_Exe'Access, Uname_Crate'Access, Uname_Pkg'Access, Conforming_With_Extensions'Access),
      68 => (Unlink_Exe'Access, Unlink_Crate'Access, Unlink_Pkg'Access, Conforming_With_Extensions'Access),
      69 => (Uniq_Exe'Access, Uniq_Crate'Access, Uniq_Pkg'Access, Conforming_With_Extensions'Access),
      70 => (Wc_Exe'Access, Wc_Crate'Access, Wc_Pkg'Access, Conforming_With_Extensions'Access),
      71 => (Which_Exe'Access, Which_Crate'Access, Which_Pkg'Access, Conforming_With_Extensions'Access),
      72 => (Whoami_Exe'Access, Whoami_Crate'Access, Whoami_Pkg'Access, Conforming_With_Extensions'Access),
      73 => (Xargs_Exe'Access, Xargs_Crate'Access, Xargs_Pkg'Access, Conforming_With_Extensions'Access),
      74 => (Yes_Exe'Access, Yes_Crate'Access, Yes_Pkg'Access, Conforming_With_Extensions'Access)];
