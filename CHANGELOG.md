...
- Compiled command inventory includes 31 POSIX-style utilities plus the non-POSIX `posix-tools` management
  executable; `awk`, `grep`, and `sed` are integrated command wrappers backed by sibling language/search
  libraries.
