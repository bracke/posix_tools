...
`head -n` prefix behavior with seed `0x48454144`, generated `tail -c` suffix
behavior with seed `0x5441494C`, and `wc -c` equivalence to input byte length
with seed `0x5EEDC0DE`.
